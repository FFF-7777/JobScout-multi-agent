...
![岗位导入与分析入口](docs/images/readme/03-job-import.png)

![结构化岗位列表](docs/images/readme/03-job-list.png)
...
| 深度分析 | 推理模型，使用更多简历细节 | 固定尝试联网，补充公司背景、业务关联与可靠风险线索；失败自动降级 | 重点岗位、公司核验、投递决策 |
...
![岗位匹配详情](docs/images/readme/05-result-detail.png)
